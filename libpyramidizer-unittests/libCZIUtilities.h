...
/// buffer.
class CMemInputOutputStream final : public libCZI::IInputOutputStream
{
private:
    char* ptr_;
    size_t alignment_for_growth_;
    size_t allocated_size_;
    size_t used_size_;
public:
    CMemInputOutputStream(const void* data, size_t size, size_t alignment_for_growth = 1);
    explicit CMemInputOutputStream(size_t initial_size, size_t alignment_for_growth = 1);
